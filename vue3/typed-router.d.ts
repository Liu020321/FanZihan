...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'declaration-analysis': RouteRecordInfo<'declaration-analysis', '/declaration/analysis', Record<never, never>, Record<never, never>>,
    'declaration-fill': RouteRecordInfo<'declaration-fill', '/declaration/fill', Record<never, never>, Record<never, never>>,
    'declaration-institutional': RouteRecordInfo<'declaration-institutional', '/declaration/institutional', Record<never, never>, Record<never, never>>,
    ...
    'interaction-communication': RouteRecordInfo<'interaction-communication', '/interaction/communication', Record<never, never>, Record<never, never>>,
    'interaction-friends': RouteRecordInfo<'interaction-friends', '/interaction/friends', Record<never, never>, Record<never, never>>,
    'interaction-occupation': RouteRecordInfo<'interaction-occupation', '/interaction/occupation', Record<never, never>, Record<never, never>>,
    'interaction-professional': RouteRecordInfo<'interaction-professional', '/interaction/professional', Record<never, never>, Record<never, never>>,
    'login': RouteRecordInfo<'login', '/login', Record<never, never>, Record<never, never>>,
    'not-authorized': RouteRecordInfo<'not-authorized', '/not-authorized', Record<never, never>, Record<never, never>>,
    'occupational-answer': RouteRecordInfo<'occupational-answer', '/occupational/answer', Record<never, never>, Record<never, never>>,
    'occupational-destination': RouteRecordInfo<'occupational-destination', '/occupational/destination', Record<never, never>, Record<never, never>>,
    'occupational-experience': RouteRecordInfo<'occupational-experience', '/occupational/experience', Record<never, never>, Record<never, never>>,
    'occupational-share': RouteRecordInfo<'occupational-share', '/occupational/share', Record<never, never>, Record<never, never>>,
